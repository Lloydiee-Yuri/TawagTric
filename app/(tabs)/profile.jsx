    ...
    <SafeAreaView className="flex-1">
      ...
      >
        <View className="flex-1 flex-row justify-between items-center w-full absolute top-0 p-8">
              ...
              <Text className="text-3xl text-gradientEnd font-pbold">Profile</Text>
        </View>
        ...
        <Text className="text-3xl text-gradientEnd font-pbold text-[3vh] mb-10">Jhon Lioyd A. Loreto</Text>
          ...
          <Text className="text-3xl text-gradientEnd font-pbold text-[2.5vh]">Total Rides: <Text className="text-3xl text-primary font-pbold text-[2.5vh]">60</Text></Text>
        </View>
